...
architecture STRUCTURE of bd_d5b8 is
  ...
  component bd_d5b8_slot_0_aw_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_d5b8_slot_0_aw_0;
  component bd_d5b8_slot_0_w_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_d5b8_slot_0_w_0;
  component bd_d5b8_slot_0_b_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_d5b8_slot_0_b_0;
  component bd_d5b8_slot_0_ar_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_d5b8_slot_0_ar_0;
  component bd_d5b8_slot_0_r_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_d5b8_slot_0_r_0;
  ...
  signal probe0_1 : STD_LOGIC_VECTOR ( 10 downto 0 );
  ...
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXI, ASSOCIATED_RESET resetn, CLK_DOMAIN system_processing_system7_0_0_FCLK_CLK0, FREQ_HZ 1e+08, INSERT_VIP 0, PHASE 0.000";
...
begin
  ...
  clk_1 <= clk;
  probe0_1(10 downto 0) <= probe0(10 downto 0);
  resetn_1 <= resetn;
...
ila_lib: component bd_d5b8_ila_lib_0
     port map (
      clk => clk_1,
      probe0(10 downto 0) => probe0_1(10 downto 0),
