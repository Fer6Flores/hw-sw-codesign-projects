...
# XDC: imports/Resources exercise LCD/lcd_8_bits_incomplete.xdc
...
# IP: bd/system/ip/system_lcd_8_bits_ip_0_0/system_lcd_8_bits_ip_0_0.xci
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==system_lcd_8_bits_ip_0_0 || ORIG_REF_NAME==system_lcd_8_bits_ip_0_0} -quiet] -quiet
...
set_property DONT_TOUCH TRUE [get_cells [split [join [get_cells -hier -filter {REF_NAME==system_xadc_wiz_0_0 || ORIG_REF_NAME==system_xadc_wiz_0_0} -quiet] {/U0 } ]/U0 ] -quiet] -quiet
