...
void LCD_On(void)
{
	// send the instruction to turn the display on
...
void LCD_Off(void)
{
	// send the instruction to turn the display off
...
void LCD_Clear(void)
{
	// send the instruction to clear the LCD
...
// Shift the data displayed in the LCD
void LCD_shift(void)
{
	LCD_WriteInst(0x18);
}
