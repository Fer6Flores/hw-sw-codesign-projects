...
proc create_root_design { parentCell } {
  ...
  set switchesAndButtons [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 switchesAndButtons ]
  ...
  # Create instance: switchesAndButtons, and set properties
  set switchesAndButtons [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 switchesAndButtons ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins switchesAndButtons/S_AXI]
  connect_bd_intf_net -intf_net switchesAndButtons_GPIO [get_bd_intf_ports switchesAndButtons] [get_bd_intf_pins switchesAndButtons/GPIO]
  connect_bd_intf_net -intf_net switchesAndButtons_GPIO2 [get_bd_intf_ports leds] [get_bd_intf_pins switchesAndButtons/GPIO2]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins switchesAndButtons/s_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins switchesAndButtons/s_axi_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs switchesAndButtons/S_AXI/Reg] SEG_switches_Reg
