...
set rc [catch {
  ...
  update_ip_catalog
  set_property ip_output_repo H:/GitR/hw-sw-codesign-projects/lcd/lcd.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
  add_files -quiet H:/GitR/hw-sw-codesign-projects/lcd/lcd.runs/synth_1/system_wrapper.dcp
