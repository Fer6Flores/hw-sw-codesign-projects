...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net switches_GPIO [get_bd_intf_ports switches] [get_bd_intf_pins switchesAndButtons/GPIO]
  connect_bd_intf_net -intf_net switches_GPIO2 [get_bd_intf_ports buttons] [get_bd_intf_pins switchesAndButtons/GPIO2]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins leds/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins switchesAndButtons/s_axi_aresetn]
